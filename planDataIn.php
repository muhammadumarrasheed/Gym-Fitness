...
<body>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">New Equipment Add Form</h2>
            </center>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter diet plan" name="plan" autocomplete="off">
    ...
    function validateForm() {
        var id = document.forms[0].userEmail.value;
        var name = document.forms[0].plan.value;
        ...
        // Email validation
        if (id === '') {
            document.getElementById('id-error').textContent = 'Please enter equipment id.';
            isValid = false;
        }

        // Name validation
        if (name === '') {
            document.getElementById('name-error').textContent = 'Please enter equipment name.';
            isValid = false;
        }
