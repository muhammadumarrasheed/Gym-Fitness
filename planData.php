...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="planData.php">Diet Plan</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <center>
                <div class="heading">
                    <center> <label class="title">Manage Diet Plan</label></center>
                </div>
            </center>
            <?php
            ...
            <div class="user-details">
                <div class="user-info">
                    ...
                    <div class="user-column">
                        <div class="user-label">Diet Plan:</div>
                        <div class="user-value"><?php echo $name; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="planDataUpd.php?updateid=<?php echo $userEmail; ?>"
