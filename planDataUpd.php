...
$sql = "select planname from `plan` where userEmail = '$useremail'";
$result = mysqli_query($con,$sql);
$row = mysqli_fetch_assoc($result);
$name = $row['planname'];
if(isset($_POST['submit'])){
$name = $_POST['name'];
$sql = "update `plan` set planname = '$name' where userEmail = '$useremail'";
$result = mysqli_query($con, $sql);
if($result){
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">Update Diet Plan Form</h2>
            </center>
            <div class="form-group">
                <label class="form-label">Name</label>
                <input type="text" class="form-control" placeholder="Enter diet plan" name="name" autocomplete="off"
                    value=<?php
                echo $name?>>
