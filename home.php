...
<body>
    <div class="container" id="container">
        ...
        <section class="main-section">
            <div class="content">
                <h1>Get The Ideal Body</h1>
                <h1>And Strong Muscles</h1>
                <h1>By Joining Us</h1>
                <p>Join our gym to achieve your fitness goals and </p>
                <p style="font-size: 16px;margin-bottom: 60px;">build a strong and healthy body.</p>
                <a href="signupForm.php" class="subscribe-button ">Join Now</a>
            </div>
        </section>
    ...
    <div class="mycontainer">
        <div class="div1">
            <h2 class="div1-heading">The <span style="color: #0a55d6;">Benefits</span> You Get When Join Us </h2>
