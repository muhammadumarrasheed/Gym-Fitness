...
if(isset($_POST['submit'])){
  ...
  if($result){
    ...
    header("Location: classDataIn.php?id=Error");
  }
}
?>
<!doctype html>
...
<body>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <?php
if ($var == "Error") {
    echo "<div class='duplicateId'>Enter Unique Class ID</div>";
}
?>
        <div class="container">
            <center>
                <h2 class="card-title" style="color:royalblue;
                font-weight: bolder; padding: 10px;">New Class Add Form</h2>
            </center>
            <div class="form-group">
                <label class="form-label">Class Id</label>
                <input type="number" class="form-control" placeholder="Enter class id" name="id" autocomplete="off">
    ...
    <footer class="footer">
        <div class="footer-content">
            <div>
                <h1>About Us</h1>
                <p class="about">Welcome to Gym Fitness, your ultimate destination for achieving your fitness
                    goals
                    and
                    leading a healthy lifestyle. We are dedicated to providing top-notch fitness facilities,
                    personalized training programs, and a supportive community to help you on your fitness
                    journey.
                </p>
            </div>
            <div>
    ...
    function validateForm() {
        ...
        // Email validation
        if (id === '') {
            document.getElementById('id-error').textContent = 'Please enter class id.';
            isValid = false;
        }

        // Name validation
        if (name === '') {
            document.getElementById('name-error').textContent = 'Please enter class name.';
            isValid = false;
        }
