...
<head>
    ...
    <title>Update User Fitness</title>
</head>
<style>
body {
    margin: 0;
...
<body>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">Update User Fitness Form</h2>
            </center>
            <div class="form-group">
                <label class="form-label">Name</label>
                <input type="text" class="form-control" placeholder="Enter user fitness" name="status"
    ...
    function validateForm() {
        ...
        // Name validation
        if (name === '') {
            document.getElementById('name-error').textContent = 'Please enter user fitness.';
            isValid = false;
        }
        return isValid;
    }
...
<div class="container my-5">
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Enter status" name="status" autocomplete="off" value=<?php
                echo $status?>>
        </div>
        <button type="submit" class="submit" name="submit">Update</button>
    </form>
