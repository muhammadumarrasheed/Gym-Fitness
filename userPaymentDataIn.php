...
<head>
    ...
    <title>Add trainer payment</title>
</head>
<style>
body {
    margin: 0;
...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a href="packageData.php">Packages</a> <a href="sessionData.php">Session</a>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">New Trainer Payment Add Form</h3>
            </center>
            <div class="form-group">
                <label class="form-label">Email address</label>
                <input type="email" class="form-control" placeholder="Enter trainer email" name="id" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    ...
                    <option> Done</option>
                </select> <span id="status-error" class="error"></span>
            </div>
            <div class="form-group">
    ...
    function validateForm() {
        ...
        // Email validation
        if (id === '') {
            document.getElementById('id-error').textContent = 'Please enter user email.';
            isValid = false;
        }

        // Name validation
        if (name === '') {
            document.getElementById('status-error').textContent = 'Please select payment status.';
            isValid = false;
        }
        if (date === '') {
