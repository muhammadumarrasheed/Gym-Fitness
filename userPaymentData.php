...
<body>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage User Payment</label></center>
                <a href="userPaymentDataIn.php" class=" btn btn-primary addUserbtn text-light"
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        ...
                        <div class="user-value"><?php echo $userEmail; ?></div>
                ...
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a
                            href="userPaymentDataUpd.php?updname=<?php echo $userEmail; ?>"
                            class=" text-light">Update</a></button><br>

                    <button class="btn btn-danger my-1"><a
                            href="userPaymentDataDel.php?delname=<?php echo $userEmail; ?>"
                            class="text-light">Delete</a></button><br>
                    <button class="btn btn-success my-1">
                        <a href="exportuserPDF.php?userEmail=<?php echo $userEmail; ?>" class="text-light">Export
                            PDF</a>
                    </button><br>
