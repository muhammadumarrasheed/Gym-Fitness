...
<head>
    ...
    <title>Equiment Dashboard</title>
</head>
<style>
body {
    margin: 0;
...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="packageData.php">Packages</a>
            <a href=" sessionData.php" class="login">Session</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage Packages</label></center>
                <a href="packageDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa-solid fa-user-plus"
                        style="font-size:30px;color:white;"></i>Add Package</a>
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        <div class="user-label">Package Id:</div>
                        <div class="user-value"><?php echo $id; ?></div>
                    </div>
                    <div class="user-column">
                        <div class="user-label">Package Name:</div>
                        <div class="user-value"><?php echo $name; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="packageDataUpd.php?updateid=<?php echo $id; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="packageDataDel.php?deleteid=<?php echo $id; ?>"
