...
<body>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage Trainer Payment</label></center>
                <a href="trainerPaymentDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa fa-usd"
                        style="font-size:20px;color:white; margin-right: 8px;"></i>Add
                    Trainer Payment</a>
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        <div class="user-label">Trainer Email:</div>
                        <div class="user-value"><?php echo $trainerEmail; ?></div>
                        <div class="user-label">Payment Status</div>
                        <div class="user-value"><?php echo $status; ?></div>

                    </div>
                    <div class="user-column">
                        <div class="user-label">Date</div>
                        <div class="user-value"><?php echo $date; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a
                            href="trainerPaymentDataUpd.php?updname=<?php echo $trainerEmail; ?>"
                            class=" text-light">Update</a></button><br>

                    <button class="btn btn-danger my-1"><a
                            href="trainerPaymentDataDel.php?delname=<?php echo $trainerEmail; ?>"
                            class="text-light">Delete</a></button><br>
                    <button class="btn btn-success my-1">
                        <a href="exporttrainerPDF.php?trainerEmail=<?php echo $trainerEmail; ?>"
                            class="text-light">Export
                            PDF</a>
                    </button><br>
