...
$sql = "update `user` set userEmail = '$email',name = '$name',password = '$password',phoneNum = '$phone',sessionid = '$sessionid', packageid = '$packageid', classid = '$classid',trainerEmail = '$trainerEmail' where userEmail = '$email'"; // update user query
$result = mysqli_query($con, $sql);
if($result){
header("Location: userProfile.php");
}else{
header("Location:  userProfile.php?error = Data is not updated");
}
}?>
                ...
                echo $password?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your phone number"
                                name="phoneNum" autocomplete="off" value=<?php
                echo $phone?>>
                        </div>
                        <div class="form-group">
