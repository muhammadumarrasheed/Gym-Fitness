...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="fitnessData.php">Fitness</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage User Fitness</label></center>
            </div>
            <?php
            ...
            <div class="user-details">
                <div class="user-info">
                    ...
                    <div class="user-column">
                        <div class="user-label">Fitness Status:</div>
                        <div class="user-value"><?php echo $status; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="fitnessDataUpd.php?updateid=<?php echo $userEmail; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="fitnessDataDel.php?deleteid=<?php echo $userEmail; ?>"
