...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE trainer SET trainer_image = '$image' WHERE traineremail = '$var'";
    ...
    if ($result) {
        ...
        header("Location: trainerProfile.php?error");
...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="trainerProfile.php">Profile</a>
    ...
    <div class="container">
        ...
        <div class="profile-card">
            ...
            <div class="card-body">
                <div class="profile-image">
                    <?php
                                ...
                                if ($image != "") {
                                    ?>
                    <img src="trainer-images/<?php echo $image; ?>">
            ...
            <div class="card-footer">
                <a href="trainerProfileUpdate.php?updateid=<?php echo $email; ?>" class="btn btn-primary"
