...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href=" sessionData.php" class="login">Session</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage Session</label></center>
                <a href="sessionDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa-solid fa-user-plus"
                        style="font-size:30px;color:white;"></i>Add Session</a>
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        <div class="user-label">Session Id:</div>
                        <div class="user-value"><?php echo $id; ?></div>
                    </div>
                    <div class="user-column">
                        <div class="user-label">Session Name:</div>
                        <div class="user-value"><?php echo $name; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="sessionDataUpd.php?updateid=<?php echo $id; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="sessionDataDel.php?deleteid=<?php echo $id; ?>"
