    ...
    <div class="container my-5">
        <div class="form-container">
            <div class="form-boundary">
                <div class="card-body">
                    <center>
                        <h2 class="card-title" style="color: black; margin-top: 60px;">Diet Plan Update Form</h2>
                    </center>
                    <form method="post">
                        <div class="form-group" id="formgroup">
                            <label class="form-label" style="font-size:18px;">Plan</label>
                            <input type="text" class="form-control" placeholder="Enter diet plan" name="plan"
        ...
        <span class="image-container">
            <h2 class="image-caption">Update User Plan</h2>
        </span>
