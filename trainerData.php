...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="trainerData.php">Trainer</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage Trainer Dashboard</label></center>
                <a href="trainerDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa-solid fa-user-plus"
                        style="font-size:30px;color:white;"></i>Add Trainer</a>
            ...
            <div class="user-details">
                ...
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="trainerDataUpd.php?updateid=<?php echo $email; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="trainerDataDel.php?deleteid=<?php echo $email; ?>"
