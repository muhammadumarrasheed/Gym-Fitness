...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="equipmentData.php">Equipments</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage Equipments</label></center>
                <a href="equipmentDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa-solid fa-user-plus"
                        style="font-size:30px;color:white;"></i>Add Equipments</a>
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        <div class="user-label">Id:</div>
                        <div class="user-value"><?php echo $id; ?></div>
                    </div>
                    <div class="user-column">
                        <div class="user-label">Equipment Name:</div>
                        <div class="user-value"><?php echo $name; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="equipmentDataUpd.php?updateid=<?php echo $id; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="equipmentDataDel.php?deleteid=<?php echo $id; ?>"
