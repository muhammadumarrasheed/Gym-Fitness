...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="userData.php">User</a>
    ...
    <div class="largecontainer">
        <div class="container">
            <div class="heading">
                <center> <label class="title">Manage User Dashboard</label></center>
                <a href="userDataIn.php" class=" btn btn-primary addUserbtn text-light"
                    class="btn btn-primary addUserbtn"><i class="fa-solid fa-user-plus"
                        style="font-size:30px;color:white;"></i>Add User</a>
            ...
            <div class="user-details">
                <div class="user-info">
                    <div class="user-column">
                        ...
                        <div class="user-value"><?php echo $email; ?></div>
                        <div class="user-label">Name:</div>
                        <div class="user-value"><?php echo $name; ?></div>
                        <div class="user-label">Password:</div>
                        <div class="user-value"><?php echo $password; ?></div>
                        <div class="user-label">Phone #:</div>
                        <div class="user-value"><?php echo $phone; ?></div>
                        <div class="user-label">Postal Code:</div>
                        <div class="user-value"><?php echo $postal; ?></div>
                    </div>
                    <div class="user-column">
                        <div class="user-label">City:</div>
                        <div class="user-value"><?php echo $city; ?></div>
                        <div class="user-label">Street ID:</div>
                        <div class="user-value"><?php echo $street; ?></div>
                        <div class="user-label">House #:</div>
                        <div class="user-value"><?php echo $house; ?></div>
                        <div class="user-label">Trainer:</div>
                        <div class="user-value"><?php echo $trainer; ?></div>
                        <div class="user-label">Class:</div>
                        <div class="user-value"><?php echo $class; ?></div>
                        <div class="user-label">Session:</div>
                        <div class="user-value"><?php echo $session; ?></div>
                    </div>
                </div>
                <div class="user-operations">
                    <button class="btn btn-primary my-1"><a href="userDataUpd.php?updateid=<?php echo $email; ?>"
                            class="text-light">Update</a></button>
                    <button class="btn btn-danger my-1"><a href="userDelete.php?deleteid=<?php echo $email; ?>"
