...
if(isset($_POST['submit'])){
  ...
  $trainerEmail= validate($_POST['id']);
...
<body>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">New User Payment Add Form</h3>
            </center>
            <div class="form-group">
                <label class="form-label">Email address</label>
                <input type="email" class="form-control" placeholder="Enter user email" name="id" autocomplete="off">
    ...
    function validateForm() {
        ...
        // Email validation
        if (id === '') {
            document.getElementById('id-error').textContent = 'Please enter trainer email.';
            isValid = false;
        }
