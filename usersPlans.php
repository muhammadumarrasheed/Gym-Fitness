...
<body>
    <div class="contact-form">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a class="active" href="usersPlans.php">Users' Plans</a>
    ...
    <div class="container" style="margin-bottom:30px;">
        ...
        <div class="operation">
            <button type="button" class="btn btn-primary my-1"><a href="usersPlanUpdate.php?updateid=' . $email . '"
    ...
    <div id="container" class="flex-container">
        <div><button type="button" class="btn btn-primary my-1" id="addUserfit"><a href=" userPlanAdded.php"
                    class="text-light">Add
                    Diet Plan</a></button></div>
    </div>
