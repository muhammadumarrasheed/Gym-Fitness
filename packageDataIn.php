...
<body>
    ...
    <form class="myForm" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="container">
            <center>
                ...
                font-weight: bolder; padding: 10px;">New Package Add Form</h2>
            </center>
            <div class="form-group">
                <label class="form-label">Package Id</label>
                <input type="number" class="form-control" placeholder="Enter package id" name="id" autocomplete="off">
                <span id="id-error" class="error"></span>
            </div>
            <div class="form-group">
                <label class="form-label">Package Name</label>
                <input type="text" class="form-control" placeholder="Enter package name" name="name" autocomplete="off">
    ...
    function validateForm() {
        ...
        // Email validation
        if (id === '') {
            document.getElementById('id-error').textContent = 'Please enter package id.';
            isValid = false;
        }

        // Name validation
        if (name === '') {
            document.getElementById('name-error').textContent = 'Please enter package name.';
            isValid = false;
        }
